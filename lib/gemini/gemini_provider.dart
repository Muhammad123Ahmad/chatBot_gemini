import 'dart:convert';
import 'package:chat_bot/gemini/gemini_model.dart';
...
class GeminiProvider extends ChangeNotifier {
  ...
  void geminiresponse(String prompt) async {
    ...
    String url =
        "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=ADD YOUR API KEY";
